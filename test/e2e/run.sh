...
# Described in docs/development/000-end-to-end-testing.md.
#
...
readonly WORK="${ROOT}/test/e2e/work"
...
usage() {
    cat >&2 <<'USAGE'
usage: test/e2e/run.sh --iso <path> [--keep]
...
baml --directory "${ROOT}/baml/installer" generate >/dev/null
cargo build --release --quiet --manifest-path "${ROOT}/baml/installer/host/Cargo.toml"
...
# what the ISO will do: see docs/decisions/015-installer-host-bridge.md.
...
# docs/development/000-end-to-end-testing.md.
