...
The first four, `oparch-work-context-create`, `oparch-work-context-list`, `oparch-snapshot-system-create` and `oparch-snapshot-work-context-create` are written. The rest are specified and not implemented, which [Remaining](state/001-remaining.md) carries as the first work.
