...
See [Dotfiles Policy](../decisions/013-dotfiles-policy.md).
...
See [Snapshot Strategy](../decisions/004-snapshot-strategy.md) and [Recovery Strategy](../decisions/014-recovery-strategy.md).
