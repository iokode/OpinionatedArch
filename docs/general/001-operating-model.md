...
See [User Model and Account Types](../decisions/001-user-model-and-account-types.md).
...
See [Dotfiles Sync](../specs/000-dotfiles-sync.md).
...
See [Encryption Strategy](../decisions/006-encryption-strategy.md).
...
See [Snapshot Strategy](../decisions/005-snapshot-strategy.md) and [GRUB Boot Policy](../decisions/008-grub-boot-policy.md).
...
- The kernel is `linux`, and it is the only kernel installed. See [Kernel Strategy](../decisions/004-kernel-strategy.md).
- The system language is English, fixed at install time. See [Localization and Time Policy](../decisions/011-localization-and-time-policy.md).
- The network stack is `NetworkManager` with `systemd-resolved`. See [Network Stack Policy](../decisions/010-network-stack-policy.md).
...
See [Oparch Tools](../decisions/013-oparch-tools.md) and the [tool documents](../tools/).
