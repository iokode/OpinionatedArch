...
4. The renderer, the dotfiles tool, `oparch-work-context-list` and the assets from the image are copied over the ones the installation took from the published repository.
