...
4. The renderer, the dotfiles tool, `oparch-work-context-list`, `oparch-work-context-create`, `oparch-snapshot-system-create`, `oparch-snapshot-work-context-create`, `oparch-snapshot-automatic-create` and the assets from the image are copied over the ones the installation took from the published repository.
