...
[oparch-snapshot-system-create](000-command.md) holds it for the whole of each snapshot it takes, [oparch-snapshot-work-context-create](../work-context-create/000-command.md) for the whole of each snapshot it takes and labels, and [oparch-snapshot-automatic-create](../automatic-create/000-command.md) for the whole of each run for the system scope.
