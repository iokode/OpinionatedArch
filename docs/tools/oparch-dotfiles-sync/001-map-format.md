...
- [Bootloader](../../decisions/009-bootloader.md) already requires copying `grub/` into `/boot`; `copy` makes that behavior explicit in the map instead of retaining a GRUB-specific special case.
