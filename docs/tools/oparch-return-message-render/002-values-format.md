...
- How many languages may be listed is not a number this format sets because the theme is what has to lay them out, as argued in `../../decisions/017-return-message-themes.md`; a number fixed here would refuse a theme that can do more and accept one that cannot do what it allows.
