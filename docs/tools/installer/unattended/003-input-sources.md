...
The encrypted secret store is a file input, obtained the same way the logo is. What it holds and what opens it are specified in [Secret Store Archive](../../dotfiles/sync/002-secret-store-archive.md).
